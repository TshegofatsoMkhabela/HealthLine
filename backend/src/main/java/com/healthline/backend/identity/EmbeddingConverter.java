...
/**
 * Stores an embedding as a comma-separated list of {@code Double.toString} values.
 * Java guarantees {@code Double.parseDouble(Double.toString(d)) == d} for every double, so
 * this round-trips a 512-dimension embedding without precision loss.
 */
@Converter
